...
Коротко обо мне: работаю программистом, закончил бакалавриат по направлению "Прикладная математика и информатика" в МАИ (Московский Авиационный Институт) и учусь в магистратуре в МАИ (тот же) на направлении "Продуктовая разработка".

В моем Github профиле вы сможете найти некоторые проекты Школы 21, лабораторные и курсовые работы из университета.
